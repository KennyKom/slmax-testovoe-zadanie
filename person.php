...
class person {
	...
	public function construct($id, $first_name, $last_name, $birth_at, $sex, $birth_city) {
	...
	public static function initTable() {
		$dbc = DBConnect::getInstance();
		if ($dbc != null) {
			$q = <<<QUERY; CREATE TABLE IF NOT EXISTS persons (id INTEGER AUTO_INCREMENT PRIMARY KEY,
